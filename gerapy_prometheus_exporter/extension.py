...
class WebService(Site):
    ...
    def __init__(self, crawler):
        ...
        self.port = crawler.settings.get('PROMETHEUS_EXPORTER_PORT', [PROMETHEUS_EXPORTER_PORT])
        self.host = crawler.settings.get('PROMETHEUS_EXPORTER_HOST', PROMETHEUS_EXPORTER_HOST)
        self.path = crawler.settings.get('PROMETHEUS_EXPORTER_PATH', PROMETHEUS_EXPORTER_PATH)
        self.interval = crawler.settings.get('PROMETHEUS_EXPORTER_UPDATE_INTERVAL', PROMETHEUS_EXPORTER_UPDATE_INTERVAL)
    ...
    def engine_started(self):
        ...
        task = task.LoopingCall(self.update)
        self.tasks.append(tsk)
        task.start(self.interval, now=True)
